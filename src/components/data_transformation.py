...
from src.entitys.artifact import (
...
class DataTransformation:
    ...
    def get_transform_data(self):
        ...
        try:
            ...
            logging.info(
                "Exited the get_transform_data method of Data transformation class"
            )
    ...
    def split_data(self, dataset, total_count):
        ...
        try:
            ...
            logging.info(
                "Exited the split_data method of Data transformation class"
            )
